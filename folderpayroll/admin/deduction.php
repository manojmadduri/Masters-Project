...
<body>
    <div style="overflow: hidden; height: 100vh;">
        ...
        <div class="task_area">
            <div class="bg_task_area">
                <p style="margin-left: 50px">Enter the following details to entertain deduction.</p>
                <hr style="border-width:1px;width:90%;text-align:center">
                <form class="addEmpForm" action="deductionProc.php" method="post">

                    <label for="emp_id">Employee ID</label>
                    <input type="text" name="emp_id">

                    <label for="deduction">Deduction Amount(USD)</label>
                    <input type="text" name="deduction" style="margin-bottom: 20px">

                    <input type="submit" value="Set Deduction" style="color: white">
                </form>
    ...
    <div id="popup">
        Deduction for the employee is entertained successfully!
    </div>
